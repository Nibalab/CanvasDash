<div class="rounded-lg w-full px-4 bg-white">
    ...
    <header class="text-center">
        <h4 class="text-2xl text-blue-400 border-b py-3 mb-3 font-bold">Edit Weather Widget</h4>
    </header>
        ...
        <form wire:submit.prevent="saveWidget">
            ...
            <footer class="mt-2 text-center flex flex-col sm:flex-row sm:space-x-4">
                <button type="button" onclick="getLocation()"
                    class="w-full text-white bg-gray-600 font-bold py-2 rounded sm:mt-0 hover:bg-gray-700 transition duration-200">
                    Get Current Location
                </button>

                <button type="submit"
                    class="w-full bg-blue-600 text-white font-bold py-2 rounded sm:mt-0 hover:bg-blue-700 transition duration-200">
                    Save
                </button>
            </footer>
